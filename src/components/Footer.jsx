      ...
      <div className="place-items-center p-3">
        <div className="flex space-x-2">
          <a href="https://www.facebook.com/share/1A4f5PGXWr/" target="_blank">
            <FaFacebookF className="text-xl text-beige" />
          </a>
          ...
          <a
            ...
            target="_blank"
          >
            <SiUpwork className="text-2xl text-beige" />
          </a>
          ...
          <a
            ...
            target="_blank"
          >
            <FaLinkedinIn className="text-xl text-beige" />
          </a>
        </div>

        <div className="gap-y-1 text-center">
          <p className="font-montserratBold text-base">
